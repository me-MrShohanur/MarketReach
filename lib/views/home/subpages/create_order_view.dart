  ...
  void _openSheet() {
    ...
    AddProductsSheet.show(
      ...
      onProductsAdded: (List<ProductModel> products) {
        ...
        log('Total discount amount: $_totalDiscount', name: 'Cart');
      },
    );
  }
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      final response = await OrderSaveService.saveOrder(
        ...
        cart: _cart,
        discount: _totalDiscount, // Pass total discount from products
        tax: tax,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      // ── Summary — green left accent (READ-ONLY fields) ───
                      _AccentCard(
...
//   void _openSheet() {
//     if (!_canAddProducts) return;
//     // AddProductsSheet.show already uses useRootNavigator: true internally,
//     // so the sheet slides over the full screen including this view's header.
//     AddProductsSheet.show(
//       context,
//       partyId: _selectedPartyId ?? 0,
//       categoryId: 1,
