...
class _PendingOrdersViewState extends State<PendingOrdersView> {
  ...
  void initState() {
    ...
    _bloc = OrderListBloc()
      ..add(LoadOrderList(fromDate: _fmt(_from), toDate: _fmt(_to)));
  }
  ...
  void _load() {
    _bloc.add(LoadOrderList(fromDate: _fmt(_from), toDate: _fmt(_to)));
  }
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            child: Column(
              children: [
                _Header(from: _from, to: _to, onDateTap: _pickDateRange),
          ...
          return Padding(
            ...
            child: _OrderCard(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => orderDetailsRoute == orderDetailsRoute
                      ? OrderDetailView(
                          orderId: order.id,
